...
const TOTAL_TIME = '~125 menit';
const STRUCTURE = [
  { n: 1, name: 'Tes Kemampuan Kognitif',          color: '#0A6E5C', timed: true,  meta: '5 subtes berurutan · ~80 menit · tidak bisa dijeda' },
  { n: 2, name: 'Tes Kepribadian',                 color: '#D97706', timed: false, meta: '225 pasang · pilih 1 dari 2 · ~30 menit' },
  { n: 3, name: 'Tes Preferensi Kerja',            color: '#0891B2', timed: false, meta: '90 pasang · pilih 1 dari 2 · ~15 menit' },
  { n: 4, name: 'Tes Penilaian Situasional (SJT)', color: '#6366F1', timed: true,  meta: '22 skenario · 4 pilihan tindakan · 30 menit · tidak bisa dijeda' },
];
