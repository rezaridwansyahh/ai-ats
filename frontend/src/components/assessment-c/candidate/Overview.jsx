...
import { Brain, Star, Settings, Lightbulb, Timer, ClipboardList, Trash2, Check, CheckCircle2, Play, Lock } from 'lucide-react';
...
const TEST_META = {
  ...
  sjt: {
    ...
    time: '30 menit',
    items: '22 skenario',
    desc: '22 skenario kepemimpinan dengan 4 pilihan tindakan tiap skenario. Mengukur 6 kompetensi inti supervisori/manajerial.',
  },
};
    ...
    <div className="max-w-[900px] mx-auto px-4 py-6">
      ...
      >
        ...
        <div className="bg-white/15 border border-white/20 rounded-lg px-3 py-2.5 flex items-center justify-between">
          <div>
            <div className="text-sm font-bold">Battery C · v10</div>
