...
export default function Setup({ initial, onSubmit, emailReadOnly = false }) {
  ...
  // Small helper so the red-border + inline message logic isn't repeated per field.
   ...
   <div className="max-w-[900px] mx-auto px-4 py-6">
      ...
      >
        ...
        <div className="bg-white/15 border border-white/25 inline-block px-4 py-1.5 rounded-full text-[11px] font-bold uppercase tracking-wider mb-3">
          Assessment · Battery C
        </div>
        <h1 className="font-serif text-3xl md:text-4xl font-bold mb-2">Selamat Datang!</h1>
        <p className="text-base opacity-90 italic mb-4">Supervisori & Manajerial</p>
        <p className="text-sm leading-relaxed max-w-2xl opacity-90 mb-4">
          Asesmen ini mengukur <strong>kemampuan kognitif, kepribadian, preferensi kerja, dan penilaian situasional kepemimpinan</strong>.
        </p>
        <div className="flex gap-2 flex-wrap">
          ...
          <span className="bg-white/12 border border-white/20 px-3.5 py-1.5 rounded-full text-[11px] font-semibold">~125 menit</span>
