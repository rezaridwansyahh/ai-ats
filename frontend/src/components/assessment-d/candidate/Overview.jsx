...
const TEST_META = {
  tk: {
    ...
    desc: 'Empat subtes terpadu: Kemampuan Umum (GI), Penalaran Verbal, Kemampuan Numerik, dan Penalaran Abstrak.',
  },
  sjt: {
    ...
    time: '30 menit',
    items: '22 skenario',
    desc: '22 skenario kepemimpinan dengan 4 pilihan tindakan tiap skenario. Mengukur 6 kompetensi inti senior leadership.',
  },
  pf: {
    ...
    desc: 'Pilih satu dari tiga pilihan (a/b/c) untuk setiap pernyataan. Mengukur 16 faktor kepribadian dengan skala sten 1–10.',
  },
  msdt: {
    ...
    time: '~20 menit',
    items: '64 pasang',
    desc: 'Pilih satu dari dua pernyataan. Mengukur 8 gaya kepemimpinan dengan analisis Task/Relationship/Effectiveness.',
  },
  papil: {
    ...
    time: '~15 menit',
    items: '90 pasang',
    desc: 'Pilih satu dari dua pernyataan. Mengukur 10 dimensi Peran dan 10 dimensi Kebutuhan dalam konteks kepemimpinan.',
  },
};
    ...
    <div className="max-w-[900px] mx-auto px-4 py-6">
      ...
      >
        ...
        <div className="bg-white/15 border border-white/20 rounded-lg px-3 py-2.5 flex items-center justify-between">
          <div>
            <div className="text-sm font-bold">Battery D · v10</div>
