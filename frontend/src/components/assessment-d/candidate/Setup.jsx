...
export default function Setup({ initial, onSubmit, emailReadOnly = false }) {
  ...
  const validate = () => {
    ...
    if (!education) errs.education = 'Pendidikan wajib dipilih.';
    if (!dateBirth) errs.dateBirth = 'Tanggal lahir wajib diisi.';
    return errs;
  };
    ...
    <div className="max-w-[900px] mx-auto px-4 py-6">
      ...
      >
        ...
        <div className="bg-white/15 border border-white/25 inline-block px-4 py-1.5 rounded-full text-[11px] font-bold uppercase tracking-wider mb-3">
          Assessment · Battery D
        </div>
        <h1 className="font-serif text-3xl md:text-4xl font-bold mb-2">Selamat Datang!</h1>
        <p className="text-base opacity-90 italic mb-4">Senior Manajerial & Eksekutif</p>
        <p className="text-sm leading-relaxed max-w-2xl opacity-90 mb-4">
          Asesmen ini mengukur <strong>kemampuan kognitif, penilaian situasional kepemimpinan, kepribadian 16PF, gaya kepemimpinan MSDT, dan preferensi kepemimpinan PAPI-L</strong>.
        </p>
        <div className="flex gap-2 flex-wrap">
          <span className="bg-white/12 border border-white/20 px-3.5 py-1.5 rounded-full text-[11px] font-semibold">5 sub-tes</span>
          <span className="bg-white/12 border border-white/20 px-3.5 py-1.5 rounded-full text-[11px] font-semibold">~165 menit</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                ...
                <Input
                  ...
                  placeholder="Contoh: General Manager / Direktur"
