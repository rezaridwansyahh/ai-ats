// localStorage bridge for Thomas-Kilmann candidate-card progress (profile + result).
// Mirrors assessment-a/utils/storage.js with a TKI-specific key.
export const SKEY = 'myx-tki-v9';
