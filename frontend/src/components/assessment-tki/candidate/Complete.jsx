    ...
    <div className="max-w-[700px] mx-auto px-4 py-6">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-5">
        ...
        <p className="text-[13px] text-slate-600 leading-relaxed mt-2">
          Mode konflik bukan penilaian baik/buruk — setiap mode memiliki kegunaan situasionalnya masing-masing.
        </p>
      ...
      {onViewReport && (
        ...
        >
          ...
          <Button
            ...
            className="w-full bg-gradient-to-br from-teal-800 to-teal-600 hover:opacity-90 h-11 gap-2"
          >
