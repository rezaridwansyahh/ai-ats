...
const TOTAL_TIME = '~60 menit';
const STRUCTURE = [
  { n: 1, name: 'Tes Kemampuan Kognitif', color: '#0A6E5C', timed: true,  meta: '2 subtes berurutan · ~20 menit · tidak bisa dijeda' },
  { n: 2, name: 'Tes Kepribadian',        color: '#7C3AED', timed: false, meta: '44 pernyataan · skala 1–5 · ~10 menit' },
  { n: 3, name: 'Tes Gaya Kerja',         color: '#0369A1', timed: false, meta: '24 kelompok · pilih M & L per kelompok · ~15 menit' },
  { n: 4, name: 'Tes Minat Kerja',        color: '#4F46E5', timed: false, meta: '108 pernyataan · YA / TIDAK · ~15 menit' },
];
