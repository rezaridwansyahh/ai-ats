...
export default function Setup({ initial, onSubmit, emailReadOnly = false }) {
  ...
  const validate = () => {
    ...
    if (!education) errs.education = 'Pendidikan wajib diisi.';
  ...
  return (
   <div className="max-w-[900px] mx-auto px-4 py-6">
      ...
      >
        ...
        <p className="text-base opacity-90 italic mb-4">Operasional & Staf Umum</p>
        <p className="text-sm leading-relaxed max-w-2xl opacity-90 mb-4">
          Asesmen ini mengukur <strong>kemampuan kognitif, kepribadian, gaya kerja, dan minat karir</strong>.
        </p>
        <div className="flex gap-2 flex-wrap">
          ...
          <span className="bg-white/12 border border-white/20 px-3.5 py-1.5 rounded-full text-[11px] font-semibold">~60 menit</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                ...
                <Input
                  ...
                  placeholder="Contoh: Staf Operasional"
