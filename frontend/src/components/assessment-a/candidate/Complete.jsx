...
const TEST_LABELS = {
  ...
  bigfive: 'Tes 2 — Kepribadian (Big Five)',
  disc: 'Tes 3 — Gaya Kerja (DISC)',
  holland: 'Tes 4 — Minat Kerja (Holland)',
};
      ...
      {allDone && (
        <div className="bg-gradient-to-br from-green-50 to-green-100/40 border-2 border-green-600 rounded-xl p-7 text-center mb-4">
          ...
          <div className="text-sm text-slate-500 leading-relaxed mb-4">
            Selamat <strong>{profile?.name}</strong>! Anda telah menyelesaikan seluruh rangkaian tes Battery A.
            <br />
