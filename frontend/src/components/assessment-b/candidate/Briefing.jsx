...
const STRUCTURE = [
  ...
  { n: 3, name: 'Tes Minat Kerja',        color: '#4F46E5', timed: false, meta: '108 pernyataan · YA / TIDAK · ~15 menit' },
  { n: 4, name: 'Tes Preferensi Kerja',   color: '#0891B2', timed: false, meta: '90 pasang · pilih 1 dari 2 · ~15 menit' },
];
