...
import { Brain, Star, Map, Settings } from 'lucide-react';
...
const INTRO = {
  ...
  holland: {
    Icon: Map,
    title: 'Tes Minat Kerja',
    fn: 'Mengukur minat vokasional menggunakan model Holland RIASEC',
    items: '108 pernyataan',
    time: '~15 menit',
    instr:
      'Jawab YA jika pernyataan mencerminkan minat, kemampuan, atau kepribadian Anda. Jawab TIDAK jika tidak. Pilih dengan jujur — minat kerja sangat individual.',
  },
  papi: {
    Icon: Settings,
