import DemoBookingService from "./demo-booking.service.js";

class DemoBookingController {
  async create(req, res) {
    try {
      const data = await DemoBookingService.createBooking(req.body);
  ...
  async getAvailability(req, res) {
    try {
      ...
      const data = await DemoBookingService.getAvailability(month);
  ...
  async getAll(req, res) {
    try {
      const data = await DemoBookingService.getAll();
  ...
  async approve(req, res) {
    try {
      ...
      const data = await DemoBookingService.approveBooking(Number(id), conference_link);
  ...
  async reject(req, res) {
    try {
      ...
      const data = await DemoBookingService.rejectBooking(Number(id), rejection_reason);
