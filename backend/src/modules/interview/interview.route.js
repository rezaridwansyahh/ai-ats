...
router.post('/job/:job_id/prep/rubric/generate-anchors', interviewController.generateRubricAnchors);
...
router.post('/:interview_id/decide-one', interviewController.decideCandidate);
