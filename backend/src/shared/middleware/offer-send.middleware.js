...
function createOfferSendUpload(documentType) {
  ...
  const storage = multer.diskStorage({
    ...
    filename: (req, file, cb) => {
      ...
      cb(null, `signed_${documentType}_${candidateSlug}_${send.offer_id}_${timestamp}${ext}`);
    },
  });
...
export { createOfferSendUpload };
export default offerSendUpload;