...
export default [
  ...
  // Asesmen (module 4)
  { id: 9,  module_id: 4, menu_id: 9  }, // Assessment A
  { id: 10, module_id: 4, menu_id: 10 }, // Assessment B
  { id: 11, module_id: 4, menu_id: 11 }, // Assessment C
  { id: 12, module_id: 4, menu_id: 12 }, // Assessment D

  // Settings (module 5)
  { id: 13, module_id: 5, menu_id: 13 }, // User Management
  { id: 14, module_id: 5, menu_id: 14 }, // Role Management
