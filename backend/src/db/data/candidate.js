export default [
  // ============================================================
  // Job 1 — Senior Frontend Engineer (Active, Myralix) — 7
  // ============================================================
  {
    id: 1, job_id: 1, applicant_id: 1, name: 'Ayu Pratiwi', last_position: 'Frontend Engineer',
    ...
    information: {
      ...
      education: [{ school: 'Universitas Indonesia', degree: "Bachelor's in Computer Science", year: 2021, tier: 'top' }],
      experience: { years_total: 4, positions: [
        { title: 'Frontend Engineer', company: 'Tokopedia', years: 2 },
        { title: 'Junior Frontend Engineer', company: 'Bukalapak', years: 2 },
      ] },
    },
    date: '2026-04-05 10:12:00', attachment: null, latest_stage: 9,
  },
  {
    id: 2, job_id: 1, applicant_id: 2, name: 'Budi Santoso', last_position: 'UI Engineer',
    ...
    information: {
      ...
      education: [{ school: 'Institut Teknologi Bandung', degree: "Bachelor's in Informatics", year: 2022, tier: 'top' }],
      experience: { years_total: 3, positions: [
        { title: 'UI Engineer', company: 'Traveloka', years: 2 },
        { title: 'Frontend Intern', company: 'Gojek', years: 1 },
      ] },
    },
    date: '2026-04-06 09:30:00', attachment: null, latest_stage: 7,
  },
  {
    id: 3, job_id: 1, applicant_id: 4, name: 'Dewi Anggraini', last_position: 'Frontend Developer',
    address: 'Jakarta, Indonesia', education: "Bachelor's in Computer Science",
    information: {
      job_position: { current: 'Frontend Developer', category: 'Frontend' },
      skills: ['React', 'Next.js', 'GraphQL', 'TypeScript', 'Tailwind CSS'],
      education: [{ school: 'Universitas Gadjah Mada', degree: "Bachelor's in Computer Science", year: 2020, tier: 'top' }],
      experience: { years_total: 5, positions: [
        { title: 'Frontend Developer', company: 'Tiket.com', years: 3 },
        { title: 'Junior Frontend Developer', company: 'Blibli', years: 2 },
      ] },
    },
    date: '2026-04-08 11:05:00', attachment: null, latest_stage: 8,
  },
  {
    id: 4, job_id: 1, applicant_id: 5, name: 'Eko Nugroho', last_position: 'React Engineer',
    ...
    information: {
      ...
      education: [{ school: 'Politeknik Elektronika Negeri Surabaya', degree: 'Diploma in Software Engineering', year: 2023, tier: 'mid' }],
      experience: { years_total: 2, positions: [{ title: 'React Engineer', company: 'OVO', years: 2 }] },
    },
    date: '2026-04-09 08:45:00', attachment: null, latest_stage: 6,
  },
  {
    id: 5, job_id: 1, applicant_id: 6, name: 'Fitri Handayani', last_position: 'Software Engineer',
    ...
    information: {
      ...
      education: [{ school: 'Universitas Gadjah Mada', degree: "Bachelor's in Computer Engineering", year: 2018, tier: 'top' }],
      experience: { years_total: 7, positions: [
        { title: 'Software Engineer', company: 'Xendit', years: 4 },
        { title: 'Frontend Engineer', company: 'Tokopedia', years: 3 },
      ] },
    },
    date: '2026-04-09 16:00:00', attachment: null, latest_stage: 10,
  },
  {
    id: 6, job_id: 1, applicant_id: 9, name: 'Irfan Maulana', last_position: 'Frontend Lead',
    ...
    information: {
      ...
      experience: { years_total: 8, positions: [
    ...
    date: '2026-04-09 13:40:00', attachment: null, latest_stage: 11,
  },
  {
    id: 7, job_id: 1, applicant_id: 10, name: 'Julia Saputra', last_position: 'Frontend Engineer',
    ...
    information: {
      ...
      education: [{ school: 'Universiti Malaya', degree: "Bachelor's in Computer Science", year: 2021, tier: 'top' }],
      experience: { years_total: 4, positions: [
        { title: 'Frontend Engineer', company: 'AirAsia', years: 2 },
        { title: 'Junior Frontend Developer', company: 'iPrice', years: 2 },
      ] },
    },
    date: '2026-04-10 15:25:00', attachment: null, latest_stage: 8,
  },

  // ============================================================
  // Job 2 — Backend Engineer (Node.js) (Active, Myralix) — 6
  // ============================================================
  {
    id: 8, job_id: 2, applicant_id: 7, name: 'Gilang Ramadhan', last_position: 'Backend Engineer',
    ...
    information: {
      ...
      education: [{ school: 'Universitas Udayana', degree: "Bachelor's in Computer Science", year: 2021, tier: 'mid' }],
      experience: { years_total: 4, positions: [
        { title: 'Backend Engineer', company: 'Halodoc', years: 2 },
        { title: 'Junior Backend Developer', company: 'Mekari', years: 2 },
      ] },
    },
    date: '2026-04-10 09:20:00', attachment: null, latest_stage: 8,
  },
  {
    id: 9, job_id: 2, applicant_id: 8, name: 'Hana Putri', last_position: 'Full-Stack Engineer',
    ...
    date: '2026-04-11 10:10:00', attachment: null, latest_stage: 7,
  },
  {
    id: 10, job_id: 2, applicant_id: 11, name: 'Kevin Wijaya', last_position: 'Senior Backend Engineer',
    ...
    information: {
      ...
      education: [{ school: 'Nanyang Technological University', degree: "Bachelor's in Computer Science", year: 2016, tier: 'top' }],
      experience: { years_total: 9, positions: [
    ...
    date: '2026-03-18 09:05:00', attachment: null, latest_stage: 11,
  },
  {
    id: 11, job_id: 2, applicant_id: 12, name: 'Laras Wulandari', last_position: 'Backend Developer',
    ...
    information: {
      ...
      education: [{ school: 'University of the Philippines', degree: "Bachelor's in Information Technology", year: 2023, tier: 'top' }],
      experience: { years_total: 2, positions: [{ title: 'Backend Developer', company: 'PayMongo', years: 2 }] },
    },
    date: '2026-03-19 12:50:00', attachment: null, latest_stage: 6,
  },
  {
    id: 12, job_id: 2, applicant_id: 13, name: 'email-tester', last_position: 'Junior Backend Developer',
    address: 'Indonesia', education: "Bachelor's in Information Technology",
    information: { years_experience: 2, skills: ['Node.js', 'Express'] },
    date: '2026-03-19 12:50:00', attachment: null, latest_stage: 6,
  },
  {
    id: 13, job_id: 2, applicant_id: 14, name: 'email-tester 2', last_position: 'Full Stack Developer',
    address: 'Indonesia', education: "Bachelor's in Information Technology",
    information: { years_experience: 2, skills: ['Node.js', 'Express'] },
    date: '2026-03-19 12:50:00', attachment: null, latest_stage: 7,
  },
  {
    id: 15, job_id: 2, applicant_id: 15, name: 'candra', last_position: 'Full Stack Developer',
    address: 'Indonesia', education: "Bachelor's in Information Technology",
    information: {
      job_position: { current: 'Full-Stack Engineer', category: 'Full Stack' },
      skills: ['Node.js', 'React', 'MongoDB', 'Express', 'JavaScript'],
  ...
  // ============================================================
  // Job 3 — Product Designer (Active, Myralix) — 1
  // ============================================================
  {
    id: 14, job_id: 3, applicant_id: 3, name: 'Citra Lestari', last_position: 'Senior Product Designer',
    ...
    information: {
      ...
      education: [{ school: 'National University of Singapore', degree: "Bachelor's in Design", year: 2019, tier: 'top' }],
      experience: { years_total: 6, positions: [
