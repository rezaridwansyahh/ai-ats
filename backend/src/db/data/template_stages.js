...
export const templateStageRows = [
  ...
  { id: 7, master_id: 2, stage_type_id: 4, name: 'Technical Assessment', stage_order: 2 },
  { id: 8, master_id: 2, stage_type_id: 3, name: 'Interview HR', stage_order: 3 },
  { id: 9, master_id: 2, stage_type_id: 3, name: 'Interview Tech Lead', stage_order: 4 },
  { id: 10, master_id: 2, stage_type_id: 5, name: 'Background Check', stage_order: 5 },
  { id: 11, master_id: 2, stage_type_id: 6, name: 'Offer Letter', stage_order: 6 },
];
